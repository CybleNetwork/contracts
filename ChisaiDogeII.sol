...
contract ChisaiDogeII is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xB5d0e9050BAF1121FbFC716c163C8CCAA677163e;
 
    string private constant _name = "Chisai Doge II";
    string private constant _symbol = "CDII";
