...
contract Debase is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public constant _name = "Debase";
    string public constant _symbol = "DEBA";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 8e5 * 10**DECIMALS;
    ...
    uint256 public constant blackHoleFee = 20;
    ...
    uint256 private constant MAX_SUPPLY = 7e9 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Debase", "DEBA", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x6E33481e84E01D45Fa872B8375ffFb804F927793;
        treasuryReceiver = 0xb188fCDB4d1cC465daf87086339aC70e458BB55C;
        insuranceFundReceiver = 0x3f00A8C8B0f9E9f0b62bD3E48A7B37e6e1605506;
        blackHole = 0x0CE85Faa3884cfAA1B6f7677bC19CB7A8088fdcd;
