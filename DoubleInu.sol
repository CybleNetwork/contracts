...
contract DoubleInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Double Inu", "DOUBLEINU") {
    
        address newOwner = address(0xfc0Cd1C417014Ec857B4a80438Be24d7AE20fA95);
    	...
    	marketingWallet = address(0xe6984BF16877C2B463974C415085a8724f0350bE); // set as marketing wallet
    ...
    function swapBack() private {
        ...
        (success,) = address(dividendTracker).call{value: ethForRewards - ethFirstHalf}("");
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1;
        minimumTokenBalanceForDividends = 1000000 * 1e18; //must hold 1 million tokens to receive dividends
    }
