...
contract CryptoWalkersWeapons is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("CryptoWalkerWeapons", "CWW") {
        activeState = State.Admin;
        _baseTokenURI = "http://api.example.com/token/";
        _vault = 1;
        freeSupplyMinted = 1;
        mainsaleSupplyMinted = 1;
        freeMintActive = false;
        tokenSupply = 1;
        rootHash = 0x92cb4a24902597f22769dc3dd7e6ff970220e186357dc06a672fbe28c91f5ac2;
    }
    ...
    {
        require(
            activeState == State.Public && freeMintActive == true,
    ...
    function getSate() public view returns (State) {
        return activeState;
    }
