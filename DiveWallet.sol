...
contract DiveWallet is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DiveWallet Token";
    string constant _symbol = "DWT";
    ...
    modifier swapping() { inSwap = true; _; inSwap = false; }
     ...
     constructor (
        ...
        WBNB = router.WETH();
        distributor = new DividendDistributor(_routerAddress);
        ...
        approve(_routerAddress, _totalSupply);
